...
![image description](Image/8.13.1.png)

- 1.2 所以将其放到同一个文件夹下

![image description](Image/8.13.2.png)

- 1.3 使用import 文件.模块 的方式导入

![image description](Image/8.13.3.png)

- 1.4 使用from 文件夹 import 模块 的方式导入

![image description](Image/8.13.4.png)

- 1.5 在msg文件夹下创建__init__.py文件

![image description](Image/8.13.5.png)

- 1.6 在__init__.py文件中写入

![image description](Image/8.13.6.png)

- 1.7 重新使用from 文件夹 import 模块 的方式导入

![image description](Image/8.13.7.png)
...
![image description](Image/8.13.8.png)

![image description](Image/8.13.9.png)
